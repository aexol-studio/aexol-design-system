...
export const Eassy = ({ fill }: IIconFill) => (
  <svg width="48" height="49" viewBox="0 0 48 49" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M32.0967 16.8034C33.1316 16.2059 34.573 16.3106 35.3737 17.6975C35.7741 18.391 36.147 19.9947 34.4911 20.9507L26.8989 25.3341C27.4256 25.1841 28.6758 25.2238 29.4766 26.6107C30.2773 27.9977 29.2931 29.4815 28.6032 29.8798C28.9483 29.6806 30.3801 29.7696 31.1808 31.1565C31.9815 32.5434 31.3464 33.8437 30.3074 34.4256C30.8341 34.2756 32.0843 34.3154 32.885 35.7023C33.6858 37.0892 33.0509 38.3714 32.016 38.9689L25.1166 42.9523C21.9933 44.4473 14.7139 45.6716 10.55 38.4596C9.56756 37.0235 7.52698 33.2401 9.90502 27.7988C9.90502 27.7988 13.7808 20.9583 14.4099 19.642C15.0391 18.3257 16.2092 15.7334 18.1139 16.483C20.0185 17.2326 19.6486 19.1412 19.2255 20.0018L16.2221 25.9686L32.0967 16.8034Z" fill={Colors[fill]} />
    <rect x="20" y="5.26978" width="2.20782" height="8.83127" transform="rotate(-7.01763 20 5.26978)" fill={Colors[fill]} />
    <rect x="26.9602" y="5.52539" width="2.20782" height="8.83127" transform="rotate(16.7903 26.9602 5.52539)" fill={Colors[fill]} />
    <rect x="33.8579" y="10.2375" width="2.20782" height="8.83127" transform="rotate(52.7189 33.8579 10.2375)" fill={Colors[fill]} />
  </svg>
)

export const Mail = ({fill}: IIconFill) => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M21 11L12.5767 17.4572C12.2389 17.7161 11.7893 17.7226 11.4453 17.4736L3 11.359V19.7002C3 20.9651 4.0125 22 5.1375 22H18.8625C20.1 22 21 20.9651 21 19.7002V11Z" fill={Colors[fill]}/>
    <path d="M21 9.5L12.1067 16L3 9.5L11.3926 3.258C11.8182 2.914 12.4324 2.914 12.858 3.258L21 9.5Z" fill={Colors[fill]}/>
  </svg>
)
...
export const ArrowDown1 = () => (
  ...
  >
    <path
      d="M25.5 21L0.818277 -2.74195e-06L50.1817 1.57354e-06L25.5 21Z"
      fill="#C4C4C4"
    />
  </svg>
);
...
export const ArrowDown2 = () => (
  ...
  >
    <path
      opacity="0.6"
      d="M21.5 21L0.282381 -2.08941e-06L42.7176 1.62039e-06L21.5 21Z"
      fill="#C4C4C4"
    />
  </svg>
);
...
export const ArrowDown3 = () => (
  ...
  >
    <path
      d="M17.5 21L0.612505 -1.27375e-06L34.3875 1.67896e-06L17.5 21Z"
      fill="#C4C4C4"
      fillOpacity="0.4"
    />
  </svg>
